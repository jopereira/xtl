 ...
 * MA 02111-1307, USA
 *
 * $Id: text.h,v 1.7 2010/08/03 13:21:32 keithsnively Exp $
 */
...
class text_format: public generic_format<Buffer> {
 ...
 public:
	...
	void input_start_string(int& n) {gchar('<');}
	void input_end_string(int& n) {gchar('>');}
 ...
 public:
	...
	void output_start_string(int n) {space();pchar('<');need=false;}
        void output_end_string() {pchar('>');need=true;}
